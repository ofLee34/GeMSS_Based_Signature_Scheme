...
int PREFIX_NAME(signHFE_FeistelPatarin)(unsigned char* sm8,
                                        ...
                                        const UINT* sk, UINT* sm)
{
//    printf("EUF_CMA_PROPERTY is set\n");   // Murat was here
...
int PREFIX_NAME(signHFE_FeistelPatarin)(unsigned char* sm8,
                                        ...
                                        const UINT* sk, UINT* sm)
{
//    printf("EUF_CMA_PROPERTY is not set\n");   // Murat was here
//    UINT sm[SIZE_SIGN_UNCOMPRESSED-SIZE_SALT_WORD]={0};
    ...
    UINT *tmp, *Hi=Hi_tab,*Hi1=Hi1_tab;
//    printf("SIZE_DIGEST_UINT: %d \n", SIZE_DIGEST_UINT);      // Murat was here
    unsigned int k;
    #if (HFEnv!=HFEm)
        unsigned int index;
    #endif
    ...
    /* MD: Print hash of the message
    printf("Hash of the message: \n");
    ...
    /* MD: Try different S0 values
    sm[0]=0x1230123012301230;
    sm[1]=0x4567456745674567;
    sm[2]=0x89abcdef; */
